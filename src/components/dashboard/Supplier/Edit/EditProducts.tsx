...
// import { Moq } from '@/components/MarketPlace/sidebar/side_bar';
const Moq = ['kg', 'g', 'lb', 'oz', 'l', 'ml', 'm', 'cm', 'mm', 'sqm', 'sqft', 'cum', 'cuft', 'pcs', 'sets', 'pairs', 'bags', 'boxes', 'cartons', 'pallets', 'rolls', 'sheets', 'units', 'others'];
