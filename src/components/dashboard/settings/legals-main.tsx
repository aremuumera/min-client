...
const PrivacyPolicy = () => (
  <div className="space-y-8">
    <div>
      ...
      <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest">Last updated: {new Date().toLocaleDateString()}</p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-3">
        ...
        <h4 className="text-base font-bold text-gray-900">1. Information We Collect</h4>
      ...
      <div className="space-y-3">
        ...
        <h4 className="text-base font-bold text-gray-900">2. How We Use Your Information</h4>
        <p className="text-sm text-gray-600 font-medium leading-relaxed">
    ...
    <div className="space-y-3">
      <h4 className="text-base font-bold text-gray-900">3. Data Security</h4>
    ...
    <div className="prose prose-gray max-w-none">
      <div className="space-y-8">
        <section className="space-y-3">
          <h4 className="text-lg font-bold text-gray-900">1. Acceptance of Terms</h4>
        ...
        <section className="space-y-3">
          <h4 className="text-lg font-bold text-gray-900">2. Use License</h4>
          <p className="text-gray-500 font-medium leading-relaxed">
        ...
        <section className="space-y-3">
          <h4 className="text-lg font-bold text-gray-900">3. User Responsibilities</h4>
          <p className="text-gray-500 font-medium leading-relaxed">
  ...
  return (
    <div className="space-y-12">
      <div className="flex flex-col md:row md:items-end justify-between gap-6">
        <div>
          <h3 className="text-2xl font-bold text-gray-900 mb-2">Inspection Policies</h3>
          ...
          {subTab === 'local' ? (
            <div className="space-y-8">
              <div className="space-y-4">
                <h4 className="text-xl font-bold text-gray-900">Local Inspection Policies</h4>
                <p className="text-gray-500 font-medium leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
                  <h5 className="font-bold text-gray-900 mb-2">Frequency</h5>
                  <p className="text-sm text-gray-500 font-medium">Conducted quarterly or as required by regulatory authorities.</p>
                </div>
                <div className="p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
                  <h5 className="font-bold text-gray-900 mb-2">Documentation</h5>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h4 className="text-xl font-bold text-gray-900">International Inspection Policies</h4>
                <p className="text-gray-500 font-medium leading-relaxed">
...
export function LegalsMain() {
  ...
  return (
    <Card className="overflow-hidden border border-gray-200 shadow-none rounded-2xl">
      <CardHeader className="bg-gray-50/50 border-b border-gray-100 p-4 sm:p-6 md:p-8">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 bg-emerald-100 text-emerald-600 rounded-xl flex items-center justify-center">
            <Scale size={20} />
          </div>
          <div>
            <h2 className="text-xl font-bold text-gray-900 tracking-tight">Legal & Compliance</h2>
            <p className="text-xs sm:text-sm font-medium text-gray-500">Legal documents and data protection policies</p>
          </div>
        </div>

        <Tabs value={activeTab} onChange={setActiveTab}>
          <TabList variant="contained" className="bg-gray-200/50 p-1 rounded-xl flex overflow-x-auto no-scrollbar max-w-full gap-1">
            <Tab value="privacy" className={`rounded-lg px-4 py-2 text-xs sm:text-sm font-semibold transition-all whitespace-nowrap shrink-0 ${activeTab === 'privacy' ? 'bg-white text-gray-900 border border-gray-200' : 'text-gray-500 hover:text-gray-700'}`}>Privacy Policy</Tab>
            <Tab value="terms" className={`rounded-lg px-4 py-2 text-xs sm:text-sm font-semibold transition-all whitespace-nowrap shrink-0 ${activeTab === 'terms' ? 'bg-white text-gray-900 border border-gray-200' : 'text-gray-500 hover:text-gray-700'}`}>Terms & Conditions</Tab>
            <Tab value="inspection" className={`rounded-lg px-4 py-2 text-xs sm:text-sm font-semibold transition-all whitespace-nowrap shrink-0 ${activeTab === 'inspection' ? 'bg-white text-gray-900 border border-gray-200' : 'text-gray-500 hover:text-gray-700'}`}>Inspection Policies</Tab>
          </TabList>
        </Tabs>
      </CardHeader>
