      ...
      items: [
        {
          ...
          items: [
            ...
            {
              key: "supplier-company-profile",
              title: "Store profile",
              href: paths.dashboard.products.companyProfile,
              permission: "settings",
            },
          ],
        },
          ...
          items: [
            {
              key: "rfq:create",
              title: "Create Rfq",
              href: paths.dashboard.rfqs.create,
              permission: "rfq",
            },
            {
              key: "rfq",
              title: "Listed RFQs",
              href: paths.dashboard.rfqs.list,
              permission: "rfq",
            },
            {
              key: "rfq-offers",
              title: "Offer Board",
              href: "/dashboard/rfq/offers",
              permission: "rfq",
            },
          ],
        },
        {
          key: "rfq-submitted-offers",
          title: "My Submitted Offers",
          href: paths.dashboard.rfqs.submittedOffers,
          permission: "products",
          icon: "receipt-long",
        },
      ],
          ...
          items: [
            {
              ...
              href: paths.dashboard.inspections.services.matrix,
              permission: "inspectors",
            },
            {
              key: "services:pricing",
              title: "Pricing & Addons",
              href: paths.dashboard.inspections.services.pricing,
              permission: "inspectors",
            },
            {
              key: "services:limits",
              title: "Operational Limits",
              href: paths.dashboard.inspections.services.limits,
              permission: "inspectors",
            },
          ],
        },
        {
          key: "inspector-profile",
          title: "Company Profile",
          href: paths.dashboard.inspections.profile,
          icon: "users",
          permission: "inspectors",
        },
      ],
    ...
    // section d (Dashboard)
    {
      ...
      items: [
        ...
        },
        {
          key: "Wishlist",
          title: "Wishlist",
          href: paths.dashboard.savedProducts,
          icon: "star-border",
        },
        {
          key: "settings",
