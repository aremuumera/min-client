export const paths = {
  ...
  marketplace: {
    ...
    mainCategory: (mainCategoryId: string) =>
      `/dashboard/products/all-mineral-cp/${mainCategoryId}`,
    subCategory: (mainCategoryId: string, subCategoryId: string) =>
      `/dashboard/products/all-mineral-cp/${mainCategoryId}/${subCategoryId}`,
    subSubCategory: (
      mainCategoryId: string,
      subCategoryId: string,
      subSubCategoryId: string,
    ) =>
      `/dashboard/products/all-mineral-cp/${mainCategoryId}/${subCategoryId}/${subSubCategoryId}`,

    recentRfQ: "/dashboard/products/rfq-products",
    companyProfile: (companyId: string | number) =>
      `/dashboard/business/${companyId}`,
    product: (productId: string | number) =>
      `/dashboard/products/details/${productId}/product`,
    productDetails: (productId: string | number, productName: string) =>
      `/dashboard/products/details/${productId}/${productName}`,
    rfqDetails: (rfqId: string | number, rfqName: string) =>
      `/dashboard/rfqs/details/${rfqId}/${rfqName}`,
  },
  ...
  dashboard: {
    ...
    chat: {
      ...
      ) => `/dashboard/chat/${threadType}/${threadId}/${itemId}`,
    },
    ...
    rfqs: {
      ...
      update: (listedRfqId: string | number) =>
        `/dashboard/rfq-list/update/${listedRfqId}`,
